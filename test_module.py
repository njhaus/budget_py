...
class UnitTests(unittest.TestCase):
    maxDiff = None
    def setUp(self):
        self.food = budget.Category("Food", 900)
        self.entertainment = budget.Category("Entertainment", 900)
        self.business = budget.Category("Business", 900)
    ...
    def test_to_string(self):
        ...
        # print(f'ACTUAL Current string output:\n{actual}')
